...
import com.ravi.foodstar.data.DataStoreRepository
...
import com.ravi.foodstar.util.Constants.Companion.DEFAULT_RECIPES_NUMBER
...
import com.ravi.foodstar.util.Constants.Companion.QUERY_SEARCH
...
class RecipesViewModel @ViewModelInject constructor(
    ...
    fun applySearchQuery(searchQuery: String): Map<String,String>{
        ...
        queries[DEFAULT_RECIPES_NUMBER] = DEFAULT_RECIPES_NUMBER
        queries[QUERY_API_KEY] = API_KEY
        queries[QUERY_ADD_RECIPE_INFORMATION] = "true"
        queries[QUERY_FILL_INGREDIENTS] = "true"
        return queries
